...
class WxPayApi
{
	...
	public static function get_code(){
		...
		$url = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxa64961dddeaa815e&redirect_uri=REDIRECT_URI&response_type=code&scope=SCOPE&state=STATE#wechat_redirect";
		Header("Location: $url");
	}
